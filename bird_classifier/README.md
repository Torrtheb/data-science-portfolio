# Bird Species Classification with Transfer Learning and Few-Shot Learning
...
- Build a bird species classifier using few-shot learning techniques with iterative pseudo-labeling to expand the training set from limited labeled samples.
...
- **Few-Shot Learning** (fewshot.ipynb, python_files/fewshot.py):
...
- **Model Fine-Tuning** (model_tune (5).ipynb, python_files/model_tune.py):
  - Setup and configuration
